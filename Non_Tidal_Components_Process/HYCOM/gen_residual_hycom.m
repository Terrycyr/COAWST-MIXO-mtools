...
lon_pick = lon_hycom(pick==1);
lat_pick = lat_hycom(pick==1);
...
pick3d = repmat(pick,1,1,n_hycomlayer);
figure;
...
b_temp3 = tv3dinterpt(b_temp,data_time,date_out3d,'linear',1);
b_s3 = tv3dinterpt(b_s,data_time,date_out3d,'linear',1);
b_u3 = tv3dinterpt(b_u,data_time,date_out3d,'linear',1);
b_v3 = tv3dinterpt(b_v,data_time,date_out3d,'linear',1);
b_el3 = tv2dinterpt(b_el,data_time,date_out2d,'linear',1);
%------------------interpolate to out date---------------------------------       
