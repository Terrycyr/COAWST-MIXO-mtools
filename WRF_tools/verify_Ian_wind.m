...
station = {'C10','C12','C13'};
%result_path = 'Ian_D2';
%result_path_GFS = 'Extract_GFS_Ian';
%domain_id = 2;

u_path='/home/ychen/West_florida/2022_IAN/WFS_2022_Uwind1.nc';
v_path='/home/ychen/West_florida/2022_IAN/WFS_2022_Vwind1.nc';
slp_path='/home/ychen/West_florida/2022_IAN/WFS_2022_Pair1.nc';
grd_path='/home/ychen/West_florida/2022_IAN/ROMS_WFS_new.nc';
...
exportgraphics(gcf,[result_path,'_d',sprintf('%02d',domain_id),'_verify_spd_dir.png'],'Resolution',300);
