...
unit_c = 32/1025;
fdir = './do/';
[ dat_out ] = read_woa_ini2( fdir, lon, lat, mask, sc, h, date_out,'o_an');
do = dat_out.*unit_c;
...
unit_c = 14/1025;
fdir = './nitrate/';
[ dat_out, no3_m, woa_dep ] = read_woa_ini2( fdir, lon, lat, mask, sc, h, date_out,'n_an');
no3 = dat_out.*unit_c;
...
unit_c = 31/1025;
fdir = './phosphate/';
[ dat_out, po4_m, woa_dep ] = read_woa_ini2( fdir, lon, lat, mask, sc, h, date_out,'p_an');
po4 = dat_out.*unit_c;
...
unit_c = 28/1025;
fdir = './silicate/';
[ dat_out ] = read_woa_ini2( fdir, lon, lat, mask, sc, h, date_out,'i_an');
si = dat_out.*unit_c;

%temp
unit_c = 1;
fdir = './temp/';
[ dat_out ] = read_woa_ini( fdir, lon, lat, mask, sc, h, date_out,'t_an');
temp = dat_out.*unit_c;
...
save('ocean_nutrients_ini.mat','do','no3','po4','sal','si','temp','-append','-v7.3');

save('ocean_nutrients_ini_roms.mat','date_out');
save('ocean_nutrients_ini_roms.mat','no3_roms','sal_roms','temp_roms','-append','-v7.3');

save('ocean_nutrients_mean_profile.mat','date_out');
save('ocean_nutrients_mean_profile.mat','woa_dep','no3_m', 'po4_m');
