...
unit_c = 14/1025;
fdir = '../GOM18/nitrate/';
[ dat_out, no3_m, no3_dep] = read_woa_ini3( fdir, lon, lat, sc, h2, date_out,'n_an',0);
[ dat_out2] = read_woa_ini3( fdir, lon, lat, sc, h2, date_out,'n_an',0);
no3 = dat_out.*unit_c;
no3_raw = dat_out2.*unit_c;
clear dat_out dat_out2

%nh4
unit_c = 14/1025;
[ dat_out ] = read_negom_ini( '../GOM18/NEGOM_nutrients.xlsx', lon, lat, sc, h2, 3);
nh4 = dat_out.*unit_c;
...
[ dat_out, po4_m, po4_dep] = read_woa_ini3( fdir, lon, lat, sc, h2, date_out,'p_an',0);
[ dat_out2] = read_woa_ini3( fdir, lon, lat, sc, h2, date_out,'p_an',0);
po4 = dat_out.*unit_c;
po4_raw = dat_out2.*unit_c;
...
unit_c = 28/1025;
fdir = '../GOM18/silicate/';
[ dat_out, si_m, si_dep] = read_woa_ini3( fdir, lon, lat, sc, h2, date_out,'i_an',0);
[ dat_out2] = read_woa_ini3( fdir, lon, lat, sc, h2, date_out,'i_an',0);
si = dat_out.*unit_c;
si_raw = dat_out2.*unit_c;
clear dat_out dat_out2
...
save(strcat('ocean_nutrients_ini_',num2str(year),'.mat'),'do','no3','nh4','po4','sal','si','temp','-append','-v7.3');
