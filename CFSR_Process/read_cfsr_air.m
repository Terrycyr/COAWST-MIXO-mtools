...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Specify Variables
grd = '../Model_grid/ROMS_WFS_10river_grid_v11.nc'; %ROMS grid
cfsr_dir = {'../CFSR/2021/t/','../CFSR/2021/hum/'}; %CFSR directory for each variables
...
rot_flag = [0,0]; %rotation flag, u==1, v==2, others == 0
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
