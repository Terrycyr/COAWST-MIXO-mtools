...
%cfsr_dir = {'../CFSR/1998_2003/t/','../CFSR/1998_2003/hum/','../CFSR/1998_2003/rain/'}; %CFSR directory for each variables
%cfsr_var = {'TMP_L103','R_H_L103','PRATE_L1_Avg_1'}; %CFSR variable names
cfsr_dir = {'../CFSR/1998_2003/t/','../CFSR/1998_2003/hum/'}; %CFSR directory for each variables
cfsr_var = {'TMP_L103','R_H_L103'}; %CFSR variable names
cfsr_deltat = 6; %time interval of the CFSR data, unit: hour
%out_var = {'t_out','hum_out','rain_out'}; %name of the output variables
out_var = {'t_out','hum_out'}; %name of the output variables
