...
u1 = load(strcat('./',outname1),'u_out');
u2 = load(strcat('./',outname2),'u_out');
u_out = u1.u_out;
...
v1 = load(strcat('./',outname1),'v_out');
v2 = load(strcat('./',outname2),'v_out');
v_out = v1.v_out;
...
ssr_d1 = load(strcat('./',outname1),'ssr_d_out');
ssr_d2 = load(strcat('./',outname2),'ssr_d_out');
ssr_d_out = ssr_d1.ssr_d_out;
ssr_d_out(:,:,end:end+size(ssr_d2.ssr_d_out,3)-1) = ssr_d2.ssr_d_out;

ssr_u1 = load(strcat('./',outname1),'ssr_u_out');
ssr_u2 = load(strcat('./',outname2),'ssr_u_out');
...
%PAR
par1 = load(['./','PAR_',num2str(year),'.mat']);
par2 = load(['./','PAR_',num2str(year+1),'.mat']);
PAR = par1.PAR;
