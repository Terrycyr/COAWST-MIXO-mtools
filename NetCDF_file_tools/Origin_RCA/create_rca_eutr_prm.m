...
load('../PAR/PAR_rca.mat');
load('../NSRDB/NSRDB.mat','WIND');
load('../SUNRISE_SUNSET/F.mat')
...
fn = [out_path, 'WFS_eutr_2001_prm.nc'];
...
VSNET1 = ones(r+2,c+2).*0.1;
VSNET2 = ones(r+2,c+2).*0.1;
VSNET3 = ones(r+2,c+2).*0.1;
VSNET4 = ones(r+2,c+2).*0.1;

ncwrite(fn,'WIND_time',time2);
ncwrite(fn,'WIND',WIND);
