...
year = 2005;
init_file = 'WFS_2005_ini_bio_mixo_sp.nc';
...
%NO23
fn = 'WFS_2005_clm_NO23_mixo_sp.nc'; delete(fn);
...
%NH4T
fn = 'WFS_2005_clm_NH4T_mixo_sp.nc'; delete(fn);
...
%PO4T
fn = 'WFS_2005_clm_PO4T_mixo_sp.nc'; delete(fn);
...
%SIT
fn = 'WFS_2005_clm_SIT_mixo_sp.nc'; delete(fn);
...
%DO
fn = 'WFS_2005_clm_DO_mixo_sp.nc'; delete(fn);
