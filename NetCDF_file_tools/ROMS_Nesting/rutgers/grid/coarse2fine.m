...
got_list = {'lon_rho'  , 'lat_rho'  , 'lon_psi'  , 'lat_psi'  ,         ...
            ...
            'Cs_r' , 'Cs_w' , 's_rho'   , 's_w'   ,                     ...
            'Vstretching' , 'Vtransform' , 'theta_b'   , 'theta_s'   ,  ...
            'depthmin',  'depthmax',   'hc',  'Tcline',   'hraw'        ...
            'lon_coast', 'lat_coast'};
...
if (got.s_rho || got.s_w || got.Cs_r || got.Cs_w)
  field_list = [field_list, 's_rho', 's_w',                             ...
                            'Cs_r',   'Cs_w'];
end

if (got.Vstretching || got.Vtransform || got.theta_b || got.theta_s)
  field_list = [field_list, 'Vstretching', 'Vtransform',                ...
                            'theta_b',   'theta_s'];
end
...
if (got.Vstretching || got.Vtransform || got.theta_b || got.theta_s)
  F.Vstretching = C.Vstretching;
  F.Vtransform = C.Vtransform;
  F.theta_b = C.theta_b;
  F.theta_s = C.theta_s;
end
