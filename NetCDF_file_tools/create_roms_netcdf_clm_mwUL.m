function create_roms_netcdf_clm_mwUL(fn,gn,t_clim,dataset_source)
...
netcdf.putAtt(nc,netcdf.getConstant('NC_GLOBAL'),'history', ['Created by ',myName,' on ' datestr(now)]);
netcdf.putAtt(nc,netcdf.getConstant('NC_GLOBAL'),'type', dataset_source);
