...
%0) Preprocessing of river data.
    ...
    out_date = datenum(2022,1,1):datenum(2023,6,1);
    time_ref = datenum(2022,9,20,0,0,0);
    year = datevec(out_date(1));
    year = year(1);
    preprocess_river_nwis;
    wa1 = load(strcat('../../Water_Atlas/WA_river_bnd_',num2str(year),'_no_ian.mat'));
    ...
    river_DO(:,:,366:517) = wa2.river_DO;
    river_SAL(:,:,366:517) = wa2.river_SAL;
    river_LDOC(:,:,366:517) = wa2.river_LDOC;
    river_LDON(:,:,366:517) = wa2.river_LDON;
    river_LDOP(:,:,366:517) = wa2.river_LDOP;
    river_LPOC(:,:,366:517) = wa2.river_LPOC;
    river_LPON(:,:,366:517) = wa2.river_LPON;
    river_LPOP(:,:,366:517) = wa2.river_LPOP;
    river_RDOC(:,:,366:517) = wa2.river_RDOC;
    river_RDON(:,:,366:517) = wa2.river_RDON;
    river_RDOP(:,:,366:517) = wa2.river_RDOP;
    river_RPOC(:,:,366:517) = wa2.river_RPOC;
    river_RPON(:,:,366:517) = wa2.river_RPON;
    river_RPOP(:,:,366:517) = wa2.river_RPOP;
    river_NH4T(:,:,366:517) = wa2.river_NH4T;
    river_NO23(:,:,366:517) = wa2.river_NO23;
    river_PO4T(:,:,366:517) = wa2.river_PO4T;
    river_SIT(:,:,366:517) = wa2.river_SIT;

    Nutri_adjust = 1.0;

%1) Enter name of netcdf forcing file to be created.
%   If it already exists it will be overwritten!!.
    forc_file='WFS_2022_2023_river_bio_mixo_no_IAN.nc';
