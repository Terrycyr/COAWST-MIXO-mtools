...
for i=1:n_gridpoints
    nud0_2d(i) = (cff2+(n_gridpoints-i)*(cff1_2d-cff2)/(n_gridpoints-1));
    nud0_3d(i) = (cff2+(n_gridpoints-i)*(cff1_3d-cff2)/(n_gridpoints-1));
end
...
% nud_2d(2:end-5,n_gridpoints+1:end-1) = 0.0;
% nud_3d(2:end-5,n_gridpoints+1:end-1) = 0.0;
