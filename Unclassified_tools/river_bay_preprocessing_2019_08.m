...
out_date = datenum(2019,1,1,0,0,0):1/24:datenum(2019,12,31,24,0,0); %
...
fn_bayini = strcat('bay_ini_',num2str(year),'_08.mat');
...
%Read river raw data
if(skip_step(1)==0)
[nutri_dat,nutri_mean] = pre_process_river_nutrients('2016-2020.xlsx',varname,n_river,on_flag); %!!!!Unfinished
...
if(skip_step(6)==0)
gen_bay_nutrients_ini('../Cruise_data',['./bay_initials_',num2str(year),'_08.xlsx']...
