...
out_date = datenum(2009,1,1,0,0,0):datenum(2009,12,31,24,0,0); %
...
var_flag(1,:) = ...
          [    0     0    0    0     0    0    1    1    0]; %STEINHATCHEE
var_flag(2,:) = ...
...
%Read river raw data
if(skip_step(1)==0)
[nutri_dat,nutri_mean] = pre_process_river_nutrients('2008-2010.xlsx',varname,n_river,on_flag); %!!!!Unfinished
