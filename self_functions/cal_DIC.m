function DIC = cal_DIC(TA,pH,sal,tin,tout,pin,pout,siin,po4in)
...
sil     =  siin;    % Concentration of silicate  in the sample (in umol/kg)
po4     = po4in;    % Concentration of phosphate in the sample (in umol/kg)
pHscale = ones(size(TA))*1;    % pH scale at which the input pH is reported ("1" means "Total Scale")
k1k2c   = ones(size(TA))*9;    % Choice of H2CO3 and HCO3- dissociation constants K1 and K2 ("4" means "Mehrbach refit")
